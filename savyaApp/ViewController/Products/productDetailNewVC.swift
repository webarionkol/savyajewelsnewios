...
import AVKit
import Foundation
class productDetailNewVC: RootBaseVC {
...
extension productDetailNewVC: UITableViewDelegate, UITableViewDataSource {
...
extension productDetailNewVC:UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "two" {
            let dvc = segue.destination as! ProductDetials2
